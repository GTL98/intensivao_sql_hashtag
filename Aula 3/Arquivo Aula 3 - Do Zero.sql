...
HAVING avaliacao_media >= (SELECT AVG(nota) FROM alugueis);  -- 100% dinâmico!!!
...
-- CREATE/DROP VIEW: Guardando o resultado de uma consulta no nosso banco de dados
	-- CREATE VIEW serve para criar uma consulta que será armazenada para posteriores análises. Essa tabela fica na pasta 'Views'. É uma tabela dinâmica, qualquer modificação nela será feita.
    -- DROP VIEW serve para excluir uma tabela presente na pasta 'Views'.
